    ...
    lines: [
        {
            name: '开场',
            lines: [
                { name: EVERY, words: 'Born of cold and winter air and mountain rain combining', class: 'row2' },
        ...
        },
        {
            ...
            lines: [
                ...
                { name: ANNA, words: 'I just can\'t. The sky\'s awake, so i\'m awake', class: 'row2' },
                ...
                { name: ELSA, words: 'Hang on!' },
                { name: ANNA, words: 'catch me!' },
                { name: ELSA, words: 'gotcha!' },
                { name: ANNA, words: 'Again' },
                { name: ELSA, words: 'Wait, Slow down! Anna!' },
                { name: ELSA, words: 'Anna. Mama! PaPa!' },
                { name: ELSA, words: 'You\'re okay, Anna. I got you.' },
                { name: BABA, words: 'Elsa, what have you done? This is getting out of hand!', class: 'row2' },
        ...
        },
        {
            ...
            lines: [
                ...
                { name: TROLLS, words: 'The heart is not so easily changed, but the head can be persuaded.', class: 'row2' },
                ...
                { name: TROLLS, words: 'Listen to me, Elsa, your power will only grow.', class: 'row2' },
                ...
                { name: BABA, words: 'No. We\'ll protect her. Sha can learn to control it. I\'m sure.', class: 'row2' },
                { name: BABA, words: 'Until then, we\'ll lock the gates. We\'ll reduce the staff', class: 'row2' },
                { name: BABA, words: 'We will limit her contact with people and keep her powers hidden from every...', class: 'row2' },
        ...
        },
        {
            ...
            lines: [
                ...
                { name: ANNA, words: 'I never see you anymore. Come out the door', class: 'row2' },
                { name: ANNA, words: 'It\'s like you\'ve gone away' },
                { name: ANNA, words: 'We used to be best buddies' },
                { name: ANNA, words: 'And now we\'re not. I wish you would tell me why', class: 'row2' },
                { name: ANNA, words: 'Do you want to build a snowman' },
